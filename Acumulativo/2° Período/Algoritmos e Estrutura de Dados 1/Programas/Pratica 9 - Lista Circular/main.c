...
int main(void)
{
  ...
  while(m != 30)
  {
    printf("\nMenu:\n01) Criar Lista\n02) Limpar Lista\n03) Inserir Inicio\n04) Inserir Fim\n05) Inserir Posicao\n06) Remover Inicio\n07) Remover Fim\n08) Remover Posicao\n09) Remover Item(todas aparicoes)\n10) Buscar Item\n11) Buscar Posicao\n12) Tamanho\n13) Status Lista\n14) Mostrar Lista\n15) Romover Centro\n16) Contar Elementos\n17) Mais Aparece\n18) Separar Listas\n19) Remover Uma Aparicao Item\n20) Interseccao\n21) Produto\n22) Encerrar\n\nDigite uma opcao: ");
    scanf("%d", &m);
    ...
    switch(m)
    {
      ...
      case 16:
        printf("\nEscolha a lista (1/2): ");
        scanf("%d", &k);
        printf("\nDigite respectivamente a matricula, nome e nota do aluno que deseja verificar: ");
        scanf("%d %s %f", &it.mat, it.nome, &it.n1);
        if(k == 1)
          r = ContaElementos(lista, it);
        else
          r = ContaElementos(lista2, it);
        if(r == -1)
          printf("\nLista nao existe\n");
        else if (r == -3)
          printf("\nLista vazia\n");
        else
          printf("\nO aluno aparece %d vezes\n", r);
        r = 0;
        break;
      ...
      case 18:
        ...
        printf("\nDigite a nota: ");
        scanf("%f", &n);
        r = SepararListas(lista, lista2, lista3, n);
        if(r == -1)
          printf("\nLista nao foi criada\n");
        else if(r == -3)
          printf("\nLista vazia\n");
      ...
      case 19:
        ...
        scanf("%d", &mat);
        if(k == 1)
          r = RemoverAparicao(lista, mat);
        else
          r = RemoverAparicao(lista2, mat);
        if(r == -1)
          printf("\nLista nao foi criada\n");
        else if(r == -3)
          printf("\nLista vazia\n");
      ...
      case 20:
        r = Interseccao(lista, lista2, lista3);
        if(r == -1)
          printf("\nLista nao foi criada\n");
        else if(r == -3)
          printf("\nLista vazia\n");
