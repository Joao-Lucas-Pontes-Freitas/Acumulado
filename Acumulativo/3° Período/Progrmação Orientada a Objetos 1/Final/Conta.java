...
public abstract class Conta implements AutenticaSenha, Serializable, Classificavel {
    protected int senha;
    ...
    public boolean eMenorQue(Classificavel o){
        ...
        return this.saldo < compara.saldo;
    }
    ...
    public Transacao getUltimaTransacao(int senha) {
        ...
        if (transacoes.isEmpty()) {
            throw new TransacoesVaziasException("Não há transações nesta conta!");
        }
    ...
    public void imprimeConta() {
        ...
        System.out.println("Data da ultima movimentacao: " + (dataUltimaMovimentacao != null ? getDataUltimaMovimentacao() : "Não existente"));
